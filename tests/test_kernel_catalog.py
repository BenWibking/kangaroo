...
EXPECTED_DEFAULT_KERNELS = {
    ...
    "particle_min",
    "particle_multiply",
    "particle_multiply_scalar",
    "particle_ne_mask",
    "particle_power",
    "particle_power_scalar",
    "particle_rdivide_scalar",
    "particle_rpower_scalar",
    "particle_rsubtract_scalar",
    "particle_scalar_max_reduce",
    "particle_scalar_min_reduce",
    "particle_subtract",
    "particle_subtract_scalar",
    "particle_sum",
